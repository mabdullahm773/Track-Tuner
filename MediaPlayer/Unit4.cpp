	...
	: TForm(Owner)
{
	...
	ShowMessage("Project - Track Tuner");
}
...
// Get the directory path from the TEdit
	...
	/////////////////////////////////////////////////////////
		...
		UnicodeString backgroundimage = "D:\\MediaPlayer\\background.jpg";
		...
		// Specify the path to your image file
		UnicodeString iconimage = "D:\\MediaPlayer\\icon.png";
